...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "localization_status.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void TableStruct::InitDefaultsImpl() {
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_MsfSensorMsgStatus_default_instance_);_MsfStatus_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_MsfStatus_default_instance_);}
...
MsfSensorMsgStatus::MsfSensorMsgStatus()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_localization_5fstatus_2eproto::InitDefaults();
  }
  SharedCtor();
