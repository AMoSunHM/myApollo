...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "map_parking_space.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "\014map_id.proto\032\022map_geometry.proto\"\213\001\n\014Pa"
...
ParkingSpace::ParkingSpace()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_map_5fparking_5fspace_2eproto::InitDefaults();
  }
  SharedCtor();
