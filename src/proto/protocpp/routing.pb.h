...
class LaneWaypoint : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.routing.LaneWaypoint) */ {
 ...
 private:
  ...
  double s_;
  friend struct protobuf_routing_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class DeadEndInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.routing.DeadEndInfo) */ {
 public:
  ...
  inline DeadEndInfo* New() const PROTOBUF_FINAL { return New(NULL); }

  DeadEndInfo* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
inline void DeadEndInfo::clear_target_point() {
