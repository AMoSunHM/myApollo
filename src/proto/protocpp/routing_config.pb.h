...
class TopicConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.routing.TopicConfig) */ {
 public:
  ...
  inline TopicConfig* New() const PROTOBUF_FINAL { return New(NULL); }

  TopicConfig* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct protobuf_routing_5fconfig_2eproto::TableStruct;
};
// -------------------------------------------------------------------
