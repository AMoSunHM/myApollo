...
class LatencyParam : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.common.LatencyParam) */ {
 public:
  ...
  inline LatencyParam* New() const PROTOBUF_FINAL { return New(NULL); }

  LatencyParam* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
template <> struct is_proto_enum< ::apollo::common::VehicleBrand> : ::google::protobuf::internal::true_type {};
template <>
